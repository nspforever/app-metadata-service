...
description: |
  ...
  Some application content, and description`,
		...
		`title: Invalid App2 without version
maintainer:
- name: firstmaintainer app1
  email: firstmaintainer@hotmail.com
company: Random Inc
...
description: |
  ...
  Some application content, and description`,
		...
		`title: Valid App3 without maintainer
version: 0.0.1
company: Random Inc
website: https://website.com
source: https://github.com/random/repo
...
description: |
	### Interesting Title,
	Some application content, and description`,
		`title: Invalid App4 without company
version: 0.0.1
maintainer:
- name: firstmaintainer app1
	email: firstmaintainer@hotmail.com
...
description: |
	### Interesting Title,
	Some application content, and description`,
		`title: Invalid App5 without website
	version: 0.0.1
	maintainer:
	- name: firstmaintainer app1
		email: firstmaintainer@hotmail.com
	...
	description: |
		### Interesting Title,
		Some application content, and description`,
		`title: Invalid App6 without source
		version: 0.0.1
		maintainer:
		- name: firstmaintainer app1
			email: firstmaintainer@hotmail.com
		...
		description: |
			### Interesting Title,
			Some application content, and description`,
		`title: Invalid App7 without license
			version: 0.0.1
			maintainer:
			- name: firstmaintainer app1
				email: firstmaintainer@hotmail.com
			...
			description: |
				### Interesting Title,
				Some application content, and description`,
		`title: Invalid App8 without description
				version: 0.0.1
				maintainer:
				- name: firstmaintainer app1
					email: firstmaintainer@hotmail.com
